    ...
    <div class="tab-content bg-light" style="width:100%;height: 70%;">
      <div class="tab-pane active bg-light" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        <div class="container bg-light mx-auto py-2" style="overflow: hidden;">
          ...
          ">
<?php 
            $YoutubeVids = file_get_contents("https://www.googleapis.com/youtube/v3/search?part=id&maxResults=1&q=".$_SESSION['City']."&type=video&key=AIzaSyBi2oHeHWH5BD2Ck_iCaznlK2BZwDep998");
      ...
      <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="landmark" role="tabpanel" aria-labelledby="place-tab">
                  ...
                  $plc-> Typeplace($_SESSION['lat'],$_SESSION['lot'],$_SESSION['City'],'Church');
                  $plc-> Typeplace($_SESSION['lat'],$_SESSION['lot'],$_SESSION['City'],'Shopping');
                  ?>  
