      ...
      <aside class="p-0 bg-dark " style="height: 100%;">
          ...
          <span class="material-icons text-light">account_circle</span>
            ...
            <div class="collapse navbar-collapse order-last" id="nav">
              ...
              <li class="nav-item">
                <a href="../../PHP/Functions/Log_out.php" class="nav-link"></a>
                <br>
              </li>
            </ul>
            </div>      
    ...
    <div class="col text-center mx-auto bg-light" style="overflow: auto;height:720px;overflow-x: hidden;">
      <div class="bg-dark text-center  p-0" style="font-family: Caveat; font-weight: bolder;">
        ...
        <span class="badge rounded-pill bg-light text-dark"><?php echo $type ?></span>
          ...
          <a href="?kind=Historical landmark"><span class="badge rounded-pill bg-primary hover-zoom">Historical landmark</span></a> 
          <a href="?kind=Church"><span class="badge rounded-pill bg-secondary">Church</span></a> 
      ...
      <form class="row g-3">
        ...
        <div class="col-auto">
          <input type="password" class="form-control" id="inputPassword2" placeholder="Search Place in Manila">
        </div>
        <div class="col-auto">
          <button type="submit" class="btn btn-primary mb-3"><span class="material-icons">search
          </span>
          </button>
        </div>
      </form>
